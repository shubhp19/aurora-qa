...
Ranks messages by TF-IDF similarity to the question.

Builds a compact context with the top-k messages.

Calls the Groq LLM with a “you must only answer from these messages” system prompt.

Returns the model’s answer in { "answer": "..." }.
...
The system is deliberately designed to say “I don’t have that information in the messages” when the underlying data doesn’t support an answer, rather than hallucinating details.
